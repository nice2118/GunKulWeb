                                    ...
                                    ?>
                                            <tr data-widget="expandable-table" aria-expanded="true">
                                                ...
                                                ?>
                                                        ...
                                                        <?php
                                                            if ($rowHeadingGroup["HG_UserCreate"] == $globalCurrentUser || CheckAdmin($globalCurrentUser)){
                                                                ...
                                                                <tr data-widget="expandable-table" aria-expanded="false">
                                                                    <td>
                                                                        <div class="card-header">
                                                                            ...
                                                                            <div class="card-tools">
                                                                                <?php
                                                                                    if ($Heading["HD_UserCreate"] == $globalCurrentUser || CheckAdmin($globalCurrentUser)){
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                            <div class="card-header">    
                                                                                                ...
                                                                                                <div class="card-tools">
                                                                                                <?php
                                                                                                    if ($Details["DT_UserCreate"] == $globalCurrentUser || CheckAdmin($globalCurrentUser)){
