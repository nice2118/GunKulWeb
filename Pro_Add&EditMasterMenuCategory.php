            ...
            for ($i = 0; $i < count($inputNames); $i++) {
                if ($inputNames[$i] != '') {
                    if ($inputcode[$i] == 0 || $inputcode[$i] == '') {
                        $sql = "INSERT INTO `masterheadingcategories` (`MC_Code`, `MC_Text`, `HC_Code`, `MC_UserCreate`, `MC_CreateDate`, `MC_ModifyDate`) VALUES ('', '$inputNames[$i]', '$inputMastercode', '{$_SESSION['User']}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);";
                    } else {    
