    <!-- Footer Start -->
    <div class="container-fluid bg-dark text-body footer mt-3 pt-3 wow fadeIn" data-wow-delay="0.1s">
            ...
            <div class="row g-3">
                <div class="col-lg-12 col-md-24">
                    ...
                    <div class="d-flex pt-2">
                        ...
                        <a class="btn btn-square btn-outline-light btn-social" href="https://www.facebook.com/GUNKUL.G"
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a href="#">2019 Gunkul Engineering Public Company Limited</a>, All Right Reserved.
                    </div>
